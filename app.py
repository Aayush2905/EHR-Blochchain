...
login_status=0
app= Flask(__name__)
app.secret_key = 'EHR PORTAL Authentication'
...
def access():
    ...
    querystring = {"authorization":"4FzGm7K6haHIMiAJfuNsSwv50rT8cROE2UBCkP9yp3bZdXDlQqC0jLU1HVkQYE3sNdph24AIztabBcTO","sender_id":"EHR PORTAL","language":"english","route":"qt","numbers":"9789862702","message":"Doctor has requested for your record."}
